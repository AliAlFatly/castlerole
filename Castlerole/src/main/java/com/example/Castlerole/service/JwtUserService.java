...
public class JwtUserService implements UserDetailsService {
    ...
    public User registerNewUser(UserDTO user) throws Exception {
        ...
        xList.addAll(jdbcTemplate.queryForList("select xCoordinate from user", Integer.class));
        xList.addAll(jdbcTemplate.queryForList("select xCoordinate from node", Integer.class));
        yList.addAll(jdbcTemplate.queryForList("select yCoordinate from user", Integer.class));
        yList.addAll(jdbcTemplate.queryForList("select yCoordinate from node", Integer.class));
        ...
        if (targetXList != null){
            ...
            newUser.setXCoordinate(xCoordinates);
        }
        else {
        ...
        if (targetYList != null){
            ...
            newUser.setYCoordinate(yCoordinates);
        }
        else {
            throw new Exception("No more grid spots left for a new castle");
        }
